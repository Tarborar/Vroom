export const mobileHTML = `
    <div class="main vertical bigGap">
        ...
        <!--#################### -- FAQ -- ####################-->
        <div class="sectionContainer vertical smallGap">
        ...
        <footer class="horizontal gap">
            ...
            <div class="sectionContainer horizontal gap footerContainer">
                ...
                <div class="vertical gap footer__supportContainer">
                    <h4 class="footer__titleNavigation">Support</h4>
                    <ul class="footer__supportContainer vertical">
                        <li><a href="">Aide</a></li>
                        <li><a href="">Service</a></li>
                        <li><a href="">Contact</a></li>
                    </ul>
                </div>
                <div class="vertical smallGap footer__newsletterContainer">
